    ...
    <div className="pointer-events-none">
      <div className="mask-[linear-gradient(white,transparent)] absolute inset-0 rounded-2xl transition duration-300 group-hover:opacity-50">
        <GridPattern
          ...
          height={56}
          x="50%"
          className="fill-black/2 dark:fill-white/1 dark:stroke-white/2.5 absolute inset-x-0 inset-y-[-30%] h-[160%] w-full skew-y-[-18deg] stroke-black/5"
          {...gridProps}
        />
      </div>
      <motion.div
        className="bg-linear-to-r absolute inset-0 rounded-2xl from-[#D7EDEA] to-[#F4FBDF] opacity-0 transition duration-300 group-hover:opacity-100 dark:from-[#202D2E] dark:to-[#303428]"
        style={style}
      />
      <motion.div
