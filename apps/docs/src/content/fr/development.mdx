...
- 🐛 **Issues** : Signaler des bugs via [GitHub Issues](https://github.com/houko/pnpm-catalog-updates/issues)
- 💬 **Discussions** : Poser des questions dans [GitHub Discussions](https://github.com/houko/pnpm-catalog-updates/discussions)
...
└── options/
    └── globalOptions.ts       # Support de variables d'environnement
