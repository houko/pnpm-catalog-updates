...
- 🐛 **Issues**: Melden Sie Bugs über [GitHub Issues](https://github.com/houko/pnpm-catalog-updates/issues)
- 💬 **Diskussionen**: Stellen Sie Fragen in [GitHub Discussions](https://github.com/houko/pnpm-catalog-updates/discussions)
...
└── options/
    └── globalOptions.ts       # Umgebungsvariablen-Unterstützung
